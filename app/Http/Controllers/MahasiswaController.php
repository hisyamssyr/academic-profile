    ...
    public function show(string $nrp): View
    {
        $mahasiswa = [
            '5025241130' => [
                ...
                'pengalaman' => [
                    ['organisasi' => 'Himpunan Mahasiswa Teknik Computer-Informatika ITS', 'peran' => 'External Affairs Staff', 'periode' => 'Mar 2026 – Present', 'poin' => ['Menjadi Person in Charge (PIC) dua kali untuk program konten Instagram "Siapin Karirmu"', 'Bertugas sebagai Liaison Officer (LO) untuk 60 peserta company visit ke Oracle dan Telkom', 'Memimpin program Benchmarking sebagai PIC, mengawasi 10+ staf magang']],
