...
@section('content')
    <section class="empty-state border-0 bg-ocean-deep text-white shadow-card-hover">
        <p class="text-6xl font-bold tracking-tight text-ocean-soft sm:text-7xl">404</p>
        <h1 class="mt-4 text-2xl font-bold tracking-tight sm:text-3xl">Halaman tidak ditemukan</h1>
        <p class="mx-auto mt-3 max-w-md leading-7 text-white/85">URL yang Anda tuju tidak tersedia di routing sandbox ini.</p>
